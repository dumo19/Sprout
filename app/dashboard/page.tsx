...
import InvestButton from "@/components/dashboard/InvestButton";
  ...
  return (
    <main className="h-screen flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-8 grid-rows-10 gap-5 px-30 py-5 grid-container">
        ...
        {/* <div className="col-start-4 col-end-5 row-start-3 row-end-5"></div> */}
        {/* <div className="col-start-4 col-end-5 row-start-5 row-end-7"></div> */}
